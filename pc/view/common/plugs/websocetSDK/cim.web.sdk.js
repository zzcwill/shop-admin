var CIM_HOST,CIM_PORT,ACCOUNT
if(window.location.host == "cls.fincs.net"){
	/*CIM服务器IP  正式*/
	 ACCOUNT = "venus_std_pro"
}
else if(window.location.host == "pre-cls.fincs.net"){
	/*CIM服务器IP  预发*/
	 ACCOUNT = "venus_std_pre"
}
else if(window.location.host == "192.168.26.39:9000"){
	/*CIM服务器IP  测试1*/
	 ACCOUNT = "venus_std_test"
}else{
	 ACCOUNT = "venus_std_dev"
}
var CIM_URI = "ws://"+window.location.host+"/ws"
